...
var Dots = function () {
    ...
    Dots.prototype.ghost = function ghost() {
...
var Circuits = function () {
    ...
    Circuits.prototype.draw = function draw() {
        var canvas = document.createElement('canvas'),
            ctx = canvas.getContext('2d'),
            size = this.size;
    ...
    Circuits.prototype.populate = function populate() {
        var size = this.size;
    ...
    Circuits.prototype.getStart = function getStart() {
        var found = false,
            col = null,
            row = null,
            free = [],
    ...
    Circuits.prototype.pickOne = function pickOne(array) {
        return array[~ ~(Math.random() * array.length)];
    };

    Circuits.prototype.setUsed = function setUsed(x, y) {
        this.scene[x].rows[y] = 1;
        this.scene[x].free--;
    };

    Circuits.prototype.isAvailable = function isAvailable(x, y) {
        var scene = this.scene;
        var result = false;
    ...
    Circuits.prototype.getDir = function getDir(fromPoint) {
        var oldDir = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
...
var Things = function () {
    ...
    Things.prototype.create = function create(circuit, velocity) {
        var done = arguments.length <= 2 || arguments[2] === undefined ? 0 : arguments[2];
    ...
    Things.prototype.update = function update() {
        this.collection.forEach(function (thing) {
            thing.update();
        });
    };

    Things.prototype.draw = function draw() {
        var _this3 = this;
    ...
    Things.prototype.setDotsGhost = function setDotsGhost(canvas) {
        this.dotsGhost = canvas;
    };

    Things.prototype.setLight = function setLight(lightRadius) {
...
var Thing = function () {
    ...
    Thing.prototype.update = function update() {
    ...
    Thing.prototype.distFromSister = function distFromSister() {
        var _this4 = this;
...
var Background = function () {
    ...
    Background.prototype.getBackground = function getBackground() {
        var canvas = document.createElement('canvas'),
            ctx = canvas.getContext('2d');
